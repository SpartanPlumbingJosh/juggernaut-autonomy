...
export async function GET(
  ...
  try {
    ...
    if (deployments.length === 0) {
      // Try finding the job directly even without a deployment
    ...
    // Get all deployments in same channel (related jobs)
    ...
    // Get verification summary for this job
