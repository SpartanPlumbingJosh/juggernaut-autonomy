    ...
    try:
        ...
        if name == "sql_query":
            ...
            if action == "task.create":
                ...
                result = await execute_sql("INSERT INTO governance_tasks (title, description, priority, task_type, assigned_worker, status, created_by) VALUES ($1, $2, $3, $4, $5, 'pending', $6) RETURNING id", [params.get("title"), params.get("description"), priority, params.get("task_type", "code"), params.get("assigned_worker", "agent-chat"), created_by])
