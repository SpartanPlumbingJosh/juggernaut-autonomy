...
async def generate_revenue_ideas(
    ...
    """Generate revenue ideas with async support and telemetry."""
    with tracer.start_as_current_span("generate_revenue_ideas"):
        try:
            logger.info("Starting revenue idea generation")
    context = context or {}
    gen = IdeaGenerator()
